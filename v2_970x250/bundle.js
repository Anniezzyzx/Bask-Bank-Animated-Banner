  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        gsap.set("#polygon", {
          attr: {
            points: "0,125 0,125 970,200 970,45"
          }
        });
        ...
        tl.staggerFrom(["#wing", "#txt_1"], .6, {
          ...
          attr: {
            points: "0,125 0,125 985,10000 985,-10000"
          },
          ease: Strong.easeInOut
        }, '-=0.3').to("polygon", 0.8, {
          x: "-=17",
          ease: Strong.easeInOut
        }, "-=0.9"); // .from(['#ef-headline'],0.1,{autoAlpha:0},'-=0.8')
